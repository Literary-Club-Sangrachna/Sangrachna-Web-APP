...
const About = () => {
  ...
  const milestones = [
    {
      year: "2005",
      event: "Foundation of Editorial Club",
      details: "A momentous beginning! The year 2018 marked the grand inauguration of the NIET Editorial Club. This landmark event established a dynamic platform dedicated to amplifying student voices and fostering a rich culture of literary creativity, laying the cornerstone for the vibrant community and the legacy that followed.",
      memoriesLink: "https://www.instagram.com/sangrachna_niet?igsh=ZG5mY3Azbmh3cTZx",
      photo: "/about/2018.png",
    },
    {
      year: "2020",
      event: "Named changes to 'Sangrachna Club'",
      details: "Flashback to a landmark year! 2020 was unforgettable as our beloved Editorial Club embraced its new identity as the Sangrachna Club. This transformation propelled us forward, solidifying our role as the official editorial club of NIET. Get ready for more innovation!",
      memoriesLink: "https://www.instagram.com/sangrachna_niet?igsh=ZG5mY3Azbmh3cTZx/",
      photo: "/about/2020.png",
    },
    {
      year: "2022",
      event: "First Club Event - Open Mic",
      details: "The year 2022 marked our solo debut! Our inaugural Open Mic wasn't just an event; it was a celebration of courage and creativity. The air buzzed with powerful poetry, heartfelt tales, and soul-stirring performances, truly bringing the spirit of Sangrachna Club to life on stage.",
      memoriesLink: "https://www.instagram.com/sangrachna_niet?igsh=ZG5mY3Azbmh3cTZx",
      photo: "/about/2022.png",
    },
    {
      year: "2024",
      event: "Library Initiative Started - Kitabghar",
      details: "A new chapter for our community began in 2024 with the launch of Kitabgarh! Our dream of creating a shared space for book lovers became a reality. This library is a testament to our collective passion, offering every student a quiet corner to get lost in a story.",
      memoriesLink: "https://www.instagram.com/sangrachna_niet?igsh=ZG5mY3Azbmh3cTZx",
      photo: "/about/2024.png",
    },
    {
      year: "2025",
      event: "Book Launched ISHQ-E-BEBASI",
      details: "Some stories are written by the heart. In 2025, we unveil a tale of passion and powerlessness with the launch of 'Ishq-e-Bebasi'. Our most ambitious project yet, this book delves into the beautiful complexities of helpless love, marking a new pinnacle of literary achievement for our authors.",
      memoriesLink: "https://www.instagram.com/sangrachna_niet?igsh=ZG5mY3Azbmh3cTZx",
      photo: "/about/2025.png",
    },
  ];
