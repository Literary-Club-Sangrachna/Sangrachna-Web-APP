...
const carouselImages = [
  { src: "/photocarousel/IMG_0340.JPG", alt: "Event 1" },
  { src: "/photocarousel/IMG_5618.JPG", alt: "Event 2" },
  { src: "/photocarousel/DSC_0916.JPG", alt: "Event 3" },
  { src: "/photocarousel/DSC_0759.JPG", alt: "Event 4" },
  { src: "/photocarousel/IMG_9385.jpg", alt: "Event 5" },
  { src: "/photocarousel/sang.JPG", alt: "Event 6" },
  { src: "/photocarousel/img2.jpg", alt: "Event 7" },
  { src: "/photocarousel/IMG_9795.jpg", alt: "Event 8" },
  { src: "/photocarousel/IMG_4801.JPG", alt: "Event 9" },
  { src: "/photocarousel/IMG_3758.JPG", alt: "Event 10" },
  { src: "/photocarousel/IMG_2112.jpg", alt: "Event 11" },
  { src: "/photocarousel/IMG_1758.jpg", alt: "Event 12" },
  { src: "/photocarousel/DSC03133.JPG", alt: "Event 13" },
  { src: "/photocarousel/DSC_0991.JPG", alt: "Event 14" },
  { src: "/photocarousel/DSC_0582.JPG", alt: "Event 15" },
  { src: "/photocarousel/DSC_0417.JPG", alt: "Event 16" },
  { src: "/photocarousel/DSC_0230.JPG", alt: "Event 17" },
  { src: "/photocarousel/DSC_0229.JPG", alt: "Event 18" },
...
<section className="py-16 bg-background">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105">
          <CardContent className="p-6 text-center space-y-4">
            ...
            <div>
              ...
              <Badge className="bg-primary text-primary-foreground mt-2">{president.position}</Badge>
            </div>
    ...
    <div className="text-center mb-12">
      ...
      <p className="text-lg text-muted-foreground">
        Supporting the vision with passion and drive
      </p>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto mb-12">
      ...
      <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105">
        <CardContent className="p-6 text-center space-y-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-foreground">शिवानी राय</h3>
            <Badge className="bg-primary text-primary-foreground mt-2">Vice President</Badge>
          </div>
          <div className="text-sm text-muted-foreground space-y-1">
            <p>B.Tech AIML</p>
          </div>
          {/* <p className="text-sm text-muted-foreground">Optional bio here</p> */}
          <div className="flex justify-center">
            <a
              href="mailto:"
              className="text-primary hover:text-primary/80 transition-colors"
      ...
      <Card className="hover:shadow-lg transition-all duration-300 hover:scale-105">
        <CardContent className="p-6 text-center space-y-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-foreground">अविनाश वर्मा</h3>
            <Badge className="bg-primary text-primary-foreground mt-2">Vice President</Badge>
          </div>
          <div className="text-sm text-muted-foreground space-y-1">
            <p>B.Tech CYS</p>
