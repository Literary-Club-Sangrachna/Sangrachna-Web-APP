...
const Library = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      ...
      {/* All content wrapped in stable fade-in AnimatedSection */}
      <AnimatedSection>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* Header Section */}
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Kitabghar</h1>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Sangrachna Kitabghar is our digital library initiative that serves as a bridge between readers and writers,
              fostering a culture of continuous learning and intellectual growth.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                {[...Array(10)].map((_, i) => (
                  <Card key={i} className="p-4">
                    <div className="aspect-[3/4] bg-muted rounded-t-lg mb-4"></div>
                  ...
                  <Card key={book.id}>
                    <div className="aspect-[3/4] relative overflow-hidden rounded-t-lg">
                      ...
                      <div className="absolute top-2 right-2 flex gap-1">
                        ...
                        {book.is_recommended && <Badge variant="secondary" className="text-xs">Recommended</Badge>}
                      </div>
                      {isAdmin && (
                    ...
                    <CardContent className="pt-0">
                      <div className="flex items-center justify-between text-xs text-muted-foreground mb-3">
                        <Badge variant="outline" className="text-xs">{book.genre || "General"}</Badge>
        ...
        <BookRequestModal open={showRequestModal} onOpenChange={setShowRequestModal} book={selectedBook} />
      </AnimatedSection>
