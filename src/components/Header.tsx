              ...
              "dropdown" in item ? (
                <div key={item.name} className="relative">
                  <button
                    ...
                    className="flex items-center px-3 py-2 text-sm font-medium text-muted-foreground hover:text-primary"
                  >
                    {item.name}
                    <ChevronDown
                  ...
                  {/* Dropdown */}
                  {isMagazineOpen && (
                    <div className="absolute left-0 mt-2 w-40 rounded-md shadow-lg bg-background border border-border z-50">
                      <div className="py-1">
